...
QUERIES = [
    ...
    "hillcrest san diego events",
    "north park san diego events",
    "ocean beach san diego events",
    "pacific beach san diego events",
    "little italy san diego events",
    "gaslamp quarter events",
    "normal heights san diego events",
    "city heights san diego events",
    "mission hills san diego events",
    "bankers hill san diego events",
    "east village san diego events",
    # LGBTQ / niche
